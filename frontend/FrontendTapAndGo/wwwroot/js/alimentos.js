document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        const alimentos = productos.filter(p => p.tipo.toLowerCase() === "comida");
        ...
        categorias.forEach(categoria => {
            ...
            alimentos.filter(a => a.categoria === categoria).forEach(item => {
        ...
        console.error(error);
        document.getElementById('contenedor-alimentos').innerHTML = "<p>Error al cargar productos.</p>";
    }
});
